...
contract Flashloan is IFlashLoanRecipient {
    ...
    ISwapRouter private constant uniswapRouterV3 = ISwapRouter(0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45);
    address constant swapRouterAddressV2 = 0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45;
    address constant sushiSwapRouterV2 = address(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506);

    uint256 amount;
    bytes uniswav3Path;
    address[] uniswapv2Path;
    string side;
    address public immutable recipientWallet;
    ...
    function receiveFlashLoan(
        ...
        uint256 profitAmount = amounts[i] - feeAmounts[i];
        TransferHelper.safeTransfer(address(tokens[i]), recipientWallet, profitAmount);
        }
